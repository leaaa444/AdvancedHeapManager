...
//
//// --- Nit za obradu KLIJENTA ---
//unsigned int __stdcall ClientHandlerThread(void* p_client_socket) {
//    SOCKET client_socket = (SOCKET)(uintptr_t)p_client_socket;
//    char recv_buffer[512];
//    int recv_len;
//
//    // Nećemo ispisivati poruke o konekciji da ne bi ometali monitor
//    // printf("INFO: Klijent povezan (Socket: %d), pokrenuta je nova nit za obradu.\n", (int)client_socket);
//
...
//    }
//
//    // printf("INFO: Klijent diskonektovan (Socket: %d), gasim nit.\n", (int)client_socket);
//    closesocket(client_socket);
//    return 0;
//}
//
//// --- Nit za vizuelni prikaz (Monitor) ---
...
//    }
//
//    // Server se gasi na Ctrl+C, za potrebe projekta ne moramo da implementiramo
//    // kompleksno gašenje.